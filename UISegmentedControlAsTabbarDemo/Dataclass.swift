...
final class Dataclass {
    ...
    var dataForExtraArray: Array = [ videoData(title: "#1 Secret to Learn Russian Fast", videoLink: "http://rme-audios-for-apps.s3.amazonaws.com/Extras-1.mp4", isSelected: true), videoData(title: "Russian Grammar Made Easy", videoLink: "http://rme-audios-for-apps.s3.amazonaws.com/Extras-2.mp4", isSelected: true), videoData(title: "Technique For Thinking in Russian", videoLink: "http://rme-audios-for-apps.s3.amazonaws.com/Extras-3.mp4", isSelected: true), videoData(title: "Never Forget Russian Words", videoLink: "http://rme-audios-for-apps.s3.amazonaws.com/Extras-4.mp4", isSelected: true), videoData(title: "R. Accelerator vs. R. Made Easy", videoLink: "http://rme-audios-for-apps.s3.amazonaws.com/Extras-5.mp4", isSelected: true)]
